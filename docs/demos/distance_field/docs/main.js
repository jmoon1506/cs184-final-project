...
/*  var isectVizMat = new THREE.ShaderMaterial( {
  ...
  // addText('The underlying shapes are green. Negative points in the signed distance field are red.', 600, -isectBufferHeight/2-32);
...
function defaultObjectParams() {
  var objectParams = [];
  objectParams.push( new BoxParam( { 'position':new THREE.Vector2(400, 0), 'size':new THREE.Vector2(40, 610), 
                           'rotation':0., 'color':"#009966", 'isStatic':false } ) );
  ...
  objectParams.push( new BoxParam( { 'position':new THREE.Vector2(0, -400), 'size':new THREE.Vector2(500, 60), 
                           'rotation':0., 'color':"#009966", 'isStatic':false } ) );
  ...
  // objectParams.push( new CircleParam( { 'position':new THREE.Vector2(180, 150), 'radius':50, 
  //                          'color':"#009966", 'emission':"#ff0000ff", 'isStatic':false } ) );
  objectParams.push( new CircleParam( { 'position':new THREE.Vector2(-200, -150), 'radius':200, 
                         'color':"#009966", 'emission':"#ff0000ff", 'isStatic':false } ) );
